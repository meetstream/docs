...
<Steps>
  <Step title="Get your Zoom app's credentials">
    ...
    <Frame>
      <img src="/images/zoom-screenshots/step-4.png" alt="Zoom App Marketplace credentials section" />
    </Frame>
  </Step>
  ...
  <Step title="Add the credentials to the MeetStream Dashboard">
    ...
    <Frame>
      <img src="/images/zoom-screenshots/step-5.png" alt="MeetStream Dashboard Zoom credentials" />
    </Frame>
  </Step>
  ...
  <Step title="View your bot in the API Explorer">
    ...
    <Frame>
      <img src="/images/zoom-screenshots/step-6.png" alt="MeetStream Bot Explorer interface" />
    </Frame>
  </Step>
</Steps>
