...
<Steps>
  ...
  <Step title="Create a new app">
    ...
    <Frame>
      <img src="/images/guides/zoom-screenshots/step-1.png" alt="Zoom App Marketplace - Click on 'Develop' tab and then 'Build App'" />
    </Frame>
  </Step>
  ...
  <Step title="Configure your new Zoom app">
    **Choose App Management Type**
    ...
    <Frame>
      <img src="/images/guides/zoom-screenshots/step-2.png" alt="Choose 'User-managed' or 'Admin-managed' app type" />
    </Frame>
  </Step>
  ...
  <Step title="Get your Zoom App Credentials">
    ...
    <Frame>
      <img src="/images/guides/zoom-screenshots/step-3.png" alt="Copy your development credentials" />
    </Frame>
